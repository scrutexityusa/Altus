...
| [0021](0021-evidence-anchoring.md)                        | Chain heads are published to a witness we cannot rewrite; the bundle carries the proof | Proposed             |
| [0022](0022-enforcement-model.md)                         | Orchestration is the wedge; provider attestation is the position                       | Accepted / direction |
